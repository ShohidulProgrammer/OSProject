...
public class WorstFit extends javax.swing.JFrame {
    ...
    private void btn_CalculateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_CalculateActionPerformed
        // TODO add your handling code here:
        DefaultTableModel model=(DefaultTableModel)outputWF.getModel();
        ...
        for (int x = 0; x < fAmount; x++) {
            for (int y = 0; y < bAmount; y++) {
                if (bCounter < bAmount && files[x] <= blocks[bCounter] ) {
                    fragmentation = blocks[bCounter] - files[x];
                    totalFragmentation += fragmentation;

                    System.out.println((x + 1) + "      " + files[x] + "       " + (blockNo[bCounter] + 1) + "       " + blocks[bCounter] + "       " + fragmentation);
                    model.addRow(new Object[]{fileNo[x],files[x],blockNo[bCounter] ,blocks[bCounter],fragmentation});
                ...
                if (x == fAmount - 1 && bCounter != bAmount) {
                    for (y = bCounter; y < bAmount; y++) {
